...
function draw() {
	...
	switch (aType) {
		case 0:
			text("Lorenz Attractor",0,-80);
			break;
		case 1:
			text("Chen Attractor",0,-80);
			break;
		case 2:
			text("Modified Chua Chaotic Attractor",0,-80);
			break;
		case 3:
			text("Modified Rossler Attractor",0,-80);
			break;
	}
	textSize(6);
	// text("Click and Drag / Spacebar");
	glow();
	orbit();
	noFill();
